...
class OrganSpecialShiftTimeModel {
  final String id;
  ...
  const OrganSpecialShiftTimeModel(
      {required this.id,
  ...
  factory OrganSpecialShiftTimeModel.fromJson(Map<String, dynamic> json) {
    ...
    if (yobi == 'Sat') yobi = '土';
    if (yobi == 'Sun') yobi = '日';
    return OrganSpecialShiftTimeModel(
      id: json['id'],
